...
{-
        Utilizando o comando:
                tempoDeEsperaTotal (take 50 (simule (estadoInicialDoServidor 1) entradaDaSimulacao2))
        com uma fila, obtive o tempo 3358
-}

--Experimento 2
{-
        Obtive tempo 0 com n° de filas >= 5, usando o comando:
                tempoDeEsperaTotal (take 50 (simule (estadoInicialDoServidor 5) entradaDaSimulacao2))
-}
